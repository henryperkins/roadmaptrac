...
- [ ] **Add the open PRs to the issues dossier** (19 open board-tracked + 16 repo-open untracked, or keep PRs only here) and add **bidirectional cross-links** across the 4 docs per item.
