...
> | **Repository radar** | `WordPress/php-ai-client`: **26** open PRs / **1.4.0** · `WordPress/mcp-adapter`: **19** / **v0.5.0** (census-only; no Project #240 coverage gate) |
